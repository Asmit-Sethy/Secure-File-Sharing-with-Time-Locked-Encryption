...
.login-container-img {
  ...
  background: url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgmvrOKWUUuUI5_nBNqU834UX4IRUdqk4RgFOAAlYn5QxJswaCNXUo_EwYkEzkHlYe1Eg&usqp=CAU');
	...
	<div class="container">
		<div class="login-container">
			<div class="login-container-img">
				<h1>Admin
					<span>Owner of the application</span>
				</h1>
			</div>
			<div class="login-container-content">
				<form action="adminlog" class="login-form" method="post">
