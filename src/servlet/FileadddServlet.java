...
public class fileupload extends HttpServlet {
	...
	*//**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String fullpath = editpath + "fileguardproject\\WebContent\\Local\\";
		...
		if (filename.endsWith(".txt")) {// if open
			...
			try {// try1 open
				...
				filepath1 = editpath + "\\fileguardproject\\WebContent\\Encrypt\\" + filename;
				...
				filepath2 = editpath + "\\fileguardproject\\WebContent\\Decrypt\\" + filename;
		...
		int ch = c;
		System.out.println("1st Asciiis: " + ch);
		...
		int secretkey = a + b+ch + 244;

		String secretkey1 = String.valueOf(secretkey);

		String asciivalue = String.valueOf(ch);

		System.out.println("secret key " + secretkey1);
		String filename1 = filename;
		String filecontent1 = filecontent;
		String encrypt = encontent;
		String decrypt = decontent;
		...
		con = (Connection) dbcon.create();
		 ...
		 String file="";
		      try {
				PreparedStatement ps1 = con.prepareStatement("SELECT * FROM `fileguard`.`uploadfile` ");
		...
		int reg = 0;
		try {
			PreparedStatement ps = con.prepareStatement("INSERT INTO fileguard.uploadfile VALUES(id,?,?,?,?,?,?)");
			ps.setString(1, filename1);
			ps.setString(2, filecontent);
			ps.setString(3, encontent);
			ps.setString(4, decontent);
			ps.setString(5, asciivalue);
			ps.setString(6, secretkey1);
	...
	private String getAlphabetInput(JFrame f, String string) {
		// TODO Auto-generated method stub
		return null;
	}
      ...
      //file decrypted and store into filepath2
		    ...
		    filepath2 = editpath + "\\fileguardproject\\WebContent\\Decrypt\\"+filename;
			 ...
			 Random random = new Random();
		        int secretkey = random.nextInt(90000) + 10000; 

			
	        int randomAsciiValue = random.nextInt(26) + 65; // 'A' starts at ASCII 65
	        
	        // Convert the random ASCII value to a character
	        char ch = (char) randomAsciiValue;

	        // Convert secretkey and ASCII value to String
	        String secretkey1 = String.valueOf(secretkey);
	        String asciivalue = String.valueOf(randomAsciiValue);

	        // Output the secret key and the ASCII value
	        System.out.println("secretkey1: " + secretkey1);  // Display secret key as a number
	        System.out.println("Random ASCII value (char): " + ch);  // Display character
	        System.out.println("Random ASCII value (number): " + asciivalue);
